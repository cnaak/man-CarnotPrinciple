...
\section{Introduction}
    ...
    knowledge by the \emph{connections that are made} in association to the aimed  illustration,
    also in its \emph{production}  and  \emph{documentation},  rather  than  developing  another
    Stirling engine model or one that is beyond Cheng and Yang's work.
