...
\section{Reversible Stirling Engine Model}
    ...
    pressure-drops would introduce irreversibilities  that  would  prevent  one  from  verifying
    Carnot's general proposition in such models. Assuming, for the  sake  of  simplicity,  while
    still allowing for different fluids to be  used,  ideal  gas  $p$-$V$-$T$  behavior  of  the
    working fluid, one has:
    %
    \begin{equation}
        \label{eq:P}
